/*	David Turati
	Metodos Computacionas
	resolução de equações lineares pelo método de gauss-jacob
*/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
int  fatora(float **mt, int m, int n){
	...
	//segunda iteração
	//verifica se o erro é maior que a condição de para dada
